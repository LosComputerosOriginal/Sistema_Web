...
function enviar(par){  
   ...
   if (par == 'cadastrar'){  
      ...
      if (document.cadastro.marcaSelect.value == ''){  
	   ...
	   document.cadastro.action='veiculos.jsp';  
       document.cadastro.submit();
...
<select id = "marcaSelect" name = "marca" onChange = "carregaModelos()">
  ...
  <tr>  
    <td height="101" bgcolor="#4682B4" align="center"><p>   
        <input type="button" onClick="enviar('cadastrar')" name="bt1" value="Confirmar Cadastro">  
        <input type="button" onClick="location.href='veiculos.jsp'" name="bt2" value="Cancelar">  
      </p>  
      <p> <strong>Status:  
